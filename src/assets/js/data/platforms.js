...
export const platforms = [
  ...
  { id: "snes", name: "SNES", emoji: "🎯", defaultColor: "#d6262a", raConsoleId: 3, libretroPlaylist: "Nintendo - Super Nintendo Entertainment System", searchAliases: ["super nintendo", "super nes"] },
  { id: "genesis", name: "Sega Genesis", emoji: "⚡", defaultColor: "#2e6db4", raConsoleId: 1, libretroPlaylist: "Sega - Mega Drive - Genesis", searchAliases: ["megadrive", "mega drive", "md"] },
  ...
  { id: "dos", name: "DOS", emoji: "💻", defaultColor: "#000000", libretroPlaylist: "DOS", catalogSource: "libretro", searchAliases: ["ms-dos", "ibm", "pc dos"] },
